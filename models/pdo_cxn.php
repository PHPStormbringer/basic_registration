...
//	$handle = $link->prepare('select * from eventcode where UserId = ? or Username = ? limit ?');
    $handle = $link->prepare('select COUNT(*) from eventcode where EventCode = ?');
